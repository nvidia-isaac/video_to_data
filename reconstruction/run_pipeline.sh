...
# Option 1: Fast alignment based on depth median
...
# Option 2: Robust alignment using FoundationPose registration and Chamfer distance
# docker compose run foundationpose-estimate-scale \
#     --mesh "$DIRECTORY/mesh_simplified.glb" \
#     --rgb "$DIRECTORY/frame_0.jpg" \
#     --depth "$DIRECTORY/depth/000000.png" \
#     --mask "$DIRECTORY/masks/1/000000.png" \
#     --intrinsics "$DIRECTORY/intrinsics/000000.json" \
#     --transform "$DIRECTORY/transform.json" \
...
# Step 12: Launch 3D Visualization
# echo "Launching 3D Visualization on http://localhost:8080 ..."
