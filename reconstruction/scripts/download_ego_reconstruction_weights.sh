...
# MANO assets still require manual setup under data/weights/hand.
set -e
...
Manual MANO setup is required for either hand-tracking mode:
  data/weights/hand/models/MANO_RIGHT.pkl

For --hand_tracking dynhamr, also install:
  data/weights/hand/BMC/*.npy

The HaMeR pipeline stages MANO_RIGHT.pkl into its canonical container layout
