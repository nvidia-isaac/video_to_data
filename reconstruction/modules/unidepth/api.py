"""
HTTP API server for UniDepth module.
...
from modules.unidepth.tasks import image_to_depth, video_to_depth
...
def health():
    ...
    return jsonify({"status": "healthy", "module": "unidepth"}), 200
...
def process_image_to_depth():
    ...
    try:
        ...
        return send_file(
            ...
            as_attachment=True,
            download_name=f"unidepth_image_results_{job_id}.zip"
        )
...
def process_video_to_depth():
    ...
    try:
        ...
        return send_file(
            ...
            mimetype='application/zip',
            as_attachment=True,
            download_name=f"unidepth_video_results_{job_id}.zip"
        )
