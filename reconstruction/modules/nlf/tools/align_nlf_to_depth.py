...
try:
    ...
    from modules.foundation_pose._impl.FoundationPose.Utils import erode_depth, bilateral_filter_depth, depth2xyzmap
    USE_FP_UTILS = True
except ImportError:
    try:
        ...
        try:
            ...
            fp_path = os.path.join(os.path.dirname(__file__), '../../foundation_pose/_impl/FoundationPose')
...
from modules.nlf._impl.icp_utils import translation_only_icp_torch
