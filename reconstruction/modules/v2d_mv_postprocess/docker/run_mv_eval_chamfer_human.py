...
_LIB_CONFIG = Path(__file__).parent.parent / "lib" / "mv_eval_chamfer_human.yaml"


def run_mv_eval_chamfer_human(
    ...
    run_in_container(
        image=IMAGE_NAME,
        module="v2d.mv.postprocess.lib.mv_eval_chamfer_human",
        inputs=inputs,
        outputs=outputs,
        dev=dev,
