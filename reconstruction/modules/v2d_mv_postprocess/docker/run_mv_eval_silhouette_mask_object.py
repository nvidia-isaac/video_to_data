...
_LIB_CONFIG = Path(__file__).parent.parent / "lib" / "mv_eval_silhouette_mask_object.yaml"


def run_mv_eval_silhouette_mask_object(
    ...
    run_in_container(
        image=IMAGE_NAME,
        module="v2d.mv.postprocess.lib.mv_eval_silhouette_mask_object",
        inputs=inputs,
        outputs=outputs,
        dev=dev,
