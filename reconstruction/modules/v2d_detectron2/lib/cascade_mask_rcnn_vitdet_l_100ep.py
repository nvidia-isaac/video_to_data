...
# Cascade Mask R-CNN with ViT-L backbone (100 epochs).
...
## mask_rcnn_vitdet_b_100ep.py (base)
...
train.init_checkpoint = "detectron2://ImageNetPretrained/MAE/mae_pretrain_vit_large.pth?matching_heuristics=True"
...
## cascade_mask_rcnn_vitdet_b_100ep.py (cascade heads)
...
## cascade_mask_rcnn_vitdet_l_100ep.py (ViT-L backbone overrides)
