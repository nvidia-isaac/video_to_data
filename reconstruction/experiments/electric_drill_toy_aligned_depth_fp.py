"""
Pipeline: electric_drill_toy Session_20260310_133326_f50 — aligned depth FP tracking
...
Run from reconstruction/:
    python experiments/electric_drill_toy_aligned_depth_fp.py
"""
...
# Reference for comparison (already computed by electric_drill_toy_f50.py)
...
# ---------------------------------------------------------------------------
# Step 4: Encode renders as video
# ---------------------------------------------------------------------------
