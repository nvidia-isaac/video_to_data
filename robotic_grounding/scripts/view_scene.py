...
Usage (Sharpa / Arctic-style Parquet under ``human_motion_data``):
    python scripts/view_scene.py \
        --motion_file source/robotic_grounding/robotic_grounding/assets/human_motion_data/arctic/arctic_processed/sequence_id=dataset_s01_ketchup_use_01/robot_name=sharpa_wave
