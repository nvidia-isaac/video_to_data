...
"""Base V2D whole-body environment configuration.
...
from robotic_grounding.tasks.v2d_whole_body.mdp.commands import TrackingCommandCfg
...
class V2DSceneCfg(InteractiveSceneCfg):
    """Scene configuration for V2D whole-body tasks. Objects are added dynamically via scene config."""
...
@configclass
class V2DEnvCfg(ManagerBasedRLEnvCfg):
    """Base V2D whole-body environment configuration."""

    scene: V2DSceneCfg = V2DSceneCfg(num_envs=1, env_spacing=3.0)
