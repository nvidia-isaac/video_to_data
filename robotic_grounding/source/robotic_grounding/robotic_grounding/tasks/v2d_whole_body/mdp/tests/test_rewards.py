...
if APP_IS_READY:
    ...
    from robotic_grounding.assets import MOTION_ASSET_DIR, WHOLE_BODY_EXAMPLE_MOTION
    from robotic_grounding.tasks.v2d_whole_body import G1SonicEEEnvCfg
...
class TestTrackingRewards(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.env_cfg = G1SonicEEEnvCfg(scene_config_path=WHOLE_BODY_EXAMPLE_MOTION)
