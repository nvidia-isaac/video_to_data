...
from robotic_grounding.tasks.v2d.mdp.terminations import (
    hand_wrist_away_from_trajectory as _v2d_hand_wrist_away_from_trajectory,
)
...
def hand_wrist_away_from_trajectory(
    ...
    """V2D hands hand-away termination with whole-body reset-freeze masking."""
    command = env.command_manager.get_term(command_name)
    terminated = _v2d_hand_wrist_away_from_trajectory(
        env,
