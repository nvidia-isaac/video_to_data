...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": "robotic_grounding.tasks.v2p_whole_body.config.sonic.g1.g1_sonic_env_cfg:G1SonicReconBodyEnvCfg",
        "rsl_rl_cfg_entry_point": "robotic_grounding.tasks.v2p_whole_body.config.sonic.g1.agents.rsl_rl_ppo_cfg:G1SonicRslRlPpoCfg",
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": "robotic_grounding.tasks.v2p_whole_body.config.sonic.g1.g1_sonic_env_cfg:G1SonicReconHandEnvCfg",
        "rsl_rl_cfg_entry_point": "robotic_grounding.tasks.v2p_whole_body.config.sonic.g1.agents.rsl_rl_ppo_cfg:G1SonicReconHandRslRlPpoCfg",
    },
)
