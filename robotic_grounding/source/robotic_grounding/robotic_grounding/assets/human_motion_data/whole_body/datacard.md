...
5 action sequences, each containing retargeted G1 motion data and object or support assets where available. <br>
In current storage formats, the folder is approximately 200MB.
