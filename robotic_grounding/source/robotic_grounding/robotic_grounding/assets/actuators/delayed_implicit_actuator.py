...
class DelayedImplicitActuator(ImplicitActuator):
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        """Initialize delay buffers for positions, velocities, and efforts."""
    ...
    def reset(self, env_ids: Sequence[int]) -> None:
        """Reset delay buffers and draw new random time lags for the given envs."""
        super().reset(env_ids)
    ...
    def compute(
        ...
        """Apply delayed setpoints and return updated articulation actions."""
