...
SHARPA_TO_MANO_MAPPING = {
    # Sharpa .* hand sites: (target MANO joint, position cost, orientation cost)
    ".*_hand_wrist_site": ("wrist", 1.0, 0.1),
    ".*_thumb_CMC_VL_site": ("thumb1", 1.0, 0.0),
    ".*_thumb_MCP_VL_site": ("thumb2", 1.0, 0.0),
    ".*_thumb_DP_site": ("thumb3", 1.0, 0.0),
    ".*_thumb_tip_site": ("thumb4", 1.0, 0.1),
    ".*_index_MCP_VL_site": ("index1", 1.0, 0.0),
    ".*_index_MP_site": ("index2", 1.0, 0.0),
    ".*_index_DP_site": ("index3", 1.0, 0.0),
    ".*_index_tip_site": ("index4", 1.0, 0.0),
    ".*_middle_MCP_VL_site": ("middle1", 1.0, 0.0),
    ".*_middle_MP_site": ("middle2", 1.0, 0.0),
    ".*_middle_DP_site": ("middle3", 1.0, 0.0),
    ".*_middle_tip_site": ("middle4", 1.0, 0.0),
    ".*_ring_MCP_VL_site": ("ring1", 1.0, 0.0),
    ".*_ring_MP_site": ("ring2", 1.0, 0.0),
    ".*_ring_DP_site": ("ring3", 1.0, 0.0),
    ".*_ring_tip_site": ("ring4", 1.0, 0.0),
    ".*_pinky_MC_site": ("pinky1", 1.0, 0.0),
    ".*_pinky_MP_site": ("pinky2", 1.0, 0.0),
    ".*_pinky_DP_site": ("pinky3", 1.0, 0.0),
