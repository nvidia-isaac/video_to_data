...
`arctic/arctic_processed/dataset_s01_box_grab_01/sharpa_wave`. An absolute path to a Parquet partition
also works.

Known-good example sequences (from `docs/EXAMPLE_SEQUENCES.md`): `dataset_s01_box_grab_01`,
`dataset_s07_box_grab_01`, `dataset_s01_mixer_use_01` (articulated), `dataset_s01_espressomachine_use_01`.
