...
Image pull denied → build locally or configure an accessible `V2D_IMAGE_REGISTRY`. Then hand off to
...
**If this fails:** image pull denied → build locally or configure an accessible `V2D_IMAGE_REGISTRY`. Disk
